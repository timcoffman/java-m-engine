...
//		}, variableElement.getSimpleName() ) ;
	...
	private class EnhancedForLoopImpl extends TreeWrapper<EnhancedForLoopTree> implements Ast.EnhancedForLoop {
		...
		@Override
		public Ast.VariableDeclarationsStatement variable() { return wrap( m_tree.getVariable() ); }
		@Override
		public Ast.Expression expression() { return wrap( m_tree.getExpression() ); }
		@Override
		public Ast.Statement statement() { return wrap( m_tree.getStatement() ); }
	}
